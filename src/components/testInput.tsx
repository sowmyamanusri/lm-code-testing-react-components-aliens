    ...
    <div className="form__container">
      ...
      <form className="form__section">
        ...
        <div className="container">
          ...
          <select aria-label="options" value={formValues.options} onChange={handleChange}>
        ...
        <div className="container">
          ...
          <textarea aria-label="reasonForSparing" value={formValues.reasonForSparing} onChange={handleChange} />
        </div>
