...
const AlliensApplicationForm:React.FC<AlliensApplicationFormProps>=()=>{
  const initialState ={speciesName:'Animals',
                      planetName:'Earth',
                      numberOfBeings:1000000000,
                      options:'4',
                       reasonForSparing: 'I am living on the Earth for long years ago'}
 const [ formValues, setFormValues ] = useState<AlliensApplicationFormProps>(initialState);
...
if(parseInt(values.numberOfBeings)< 1000000000){
  ...
  errors.numberOfBeings = "characters and special characters are not allowed";
...
<div className ="form__container">
 ...
 <label className="form__label">
   ...
   <select  name ="options" value ={formValues.options} onChange={handleChange}>
 ...
 <div className ="container">
   ...
   <textarea name="reasonForSparing" value={formValues.reasonForSparing} onChange={handleChange}/>
 </div>
